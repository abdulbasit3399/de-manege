...
@extends('templates.minimal.layouts.master')
@section('style')
...
@section('content')
    ...
    <section class="banner-section">
        ...
        <div class="banner-shape01">
             <img src="{{asset('assets/templates/minimal/images/animation/banner-shape.png')}}" alt="banner" style="display:none;">
        </div>
        ...
        <div class="circle-2 three" data-paroller-factor="-0.30" data-paroller-factor-lg="0.60"
             data-paroller-type="foreground" data-paroller-direction="horizontal">
            <img src="{{asset('assets/templates/minimal/images/animation/11.png')}}" alt="shape">
        </div>

        <div class="circle-2 five" data-paroller-factor="-0.30" data-paroller-factor-lg="0.60"
             data-paroller-type="foreground" data-paroller-direction="horizontal">
            <img src="{{asset('assets/templates/minimal/images/animation/15.png')}}" alt="shape">
        </div>
    ...
    @foreach(json_decode($sections->secs) as $sec)
        @include('templates.minimal.sections.'.$sec)
    @endforeach
    @endif
