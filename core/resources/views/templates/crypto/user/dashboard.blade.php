...
@section('style')
<link rel="stylesheet" type="text/css" href="{{asset('assets/crypto/css/vendors/animate.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/crypto/css/vendors/chartist.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/crypto/css/vendors/date-picker.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/crypto/css/style.css')}}">
          ...
          <div class="col-xl-6 col-lg-6 xl-50 morning-sec box-col-12">
            <div class="card profile-greeting">
              <div class="card-body pb-0">
                ...
                <div class="cartoon"><img class="img-fluid" src="{{ asset('assets/crypto/images/dashboard/cartoon.png') }}" alt=""></div>
              </div>
            </div>
          </div>
          <div class="col-xl-6 col-lg-6 xl-50 calendar-sec box-col-6">
            <div class="card">
                <div class="card-header" style="padding: 10px 28px;">
                  <div class="header-top">
                    <h5 class="m-0">@lang('Total Investment')</h5>
                ...
                <div class="card-body">
                  <div class="w-100 h-100">
                      <canvas id="simple-doughnut-chart" width="400px" height="350px"></canvas>
                  </div>
                </div>
              </div>
				...
				<div class="card o-hidden static-top-widget-card">
					<div class="card-body">
						<div class="media static-top-widget">
							<div class="media-body">
								<h6 class="font-roboto">{{$textVar}}</h6>
								<h4 class="mb-0">{{$general->cur_sym}}<span class="counter">{{formatter_money($data->balance)}}</span></h4>
							</div>
			...
			<div class="col-sm-6 col-xl-3 col-lg-6">
				<div class="card o-hidden static-top-widget-card">
					<div class="card-body">
						<div class="media static-top-widget">
							<div class="media-body">
								<h6 class="font-roboto">@lang('Total Invest')</h6>
								<h4 class="mb-0 ">{{$general->cur_sym}}<span class="counter">{{formatter_money($totalInvest)}}</span></h4>
							</div>
			...
			<div class="col-sm-6 col-xl-3 col-lg-6">
				<div class="card o-hidden">
					<div class="card-body">
						<div class="media static-top-widget">
							<div class="media-body">
								<h6 class="font-roboto">@lang("Total Withdraw")</h6>
								<h4 class="mb-0 ">{{$general->cur_sym}}<span class="counter">{{formatter_money($totalWithdraw)}}</span></h4>
							</div>
			...
			{{-- <div class="col-sm-6 col-xl-3 col-lg-6">
				<div class="card o-hidden">
					<div class="card-body">
						<div class="media static-top-widget">
							<div class="media-body">
								<h6 class="font-roboto">@lang('Total Deposit')</h6>
								<h4 class="mb-0">{{$general->cur_sym}}<span class="counter">{{formatter_money($totalDeposit)}}</span></h4>
							</div>
	...
	<!-- Container-fluid Ends-->
          ...
          <div class="col-xl-4 xl-50 news box-col-6">
            <div class="card">
              ...
              <div class="card-body p-0">
                <div class="news-update media"><img class="img-fluid me-3 b-r-10" src=" {{ asset('assets/crypto/images/dashboard/update/1.jpg') }}" alt="">
                  <div class="media-body">
                ...
                <div class="news-update media"><img class="img-fluid me-3 b-r-10" src=" {{ asset('assets/crypto/images/dashboard/update/2.jpg') }}" alt="">
                  <div class="media-body">
                ...
                <div class="news-update media"><img class="img-fluid me-3 b-r-10" src=" {{ asset('assets/crypto/images/dashboard/update/3.jpg') }}" alt="">
                  <div class="media-body">
                ...
                <div class="media">
                  <div class="media-body">
                    <div class="d-flex mb-3">
                      <div class="inner-img"><img class="img-fluid" src=" {{ asset('assets/crypto/images/notification/1.jpg') }}" alt="Product-1"></div>
                      <div class="inner-img"><img class="img-fluid" src=" {{ asset('assets/crypto/images/notification/2.jpg') }}" alt="Product-2"></div>
...
@endsection
@section('scripts')
<script src="{{asset('assets/crypto/js/counter/jquery.waypoints.min.js')}}"></script>
<script src="{{asset('assets/crypto/js/counter/jquery.counterup.min.js')}}"></script>
<script src="{{asset('assets/crypto/js/counter/counter-custom.js')}}"></script>

<script src="{{asset('assets/crypto/js/chart/chartist/chartist.js')}}"></script>
<script src="{{asset('assets/crypto/js/chart/chartist/chartist-plugin-tooltip.js')}}"></script>
<script src="{{asset('assets/crypto/js/chart/knob/knob.min.js')}}"></script>
<script src="{{asset('assets/crypto/js/chart/knob/knob-chart.js')}}"></script>
<script src="{{asset('assets/crypto/js/chart/apex-chart/apex-chart.js')}}"></script>
{{--  <script src="{{asset('assets/crypto/js/chart/apex-chart/stock-prices.js')}}"></script>  --}}
<script src="{{asset('assets/crypto/js/notify/bootstrap-notify.min.js')}}"></script>
<script src="{{asset('assets/crypto/js/dashboard/default.js')}}"></script>
{{--  <script src="{{asset('assets/crypto/js/notify/index.js')}}"></script>  --}}
<script src="{{asset('assets/crypto/js/datepicker/date-picker/datepicker.js')}}"></script>
<script src="{{asset('assets/crypto/js/datepicker/date-picker/datepicker.en.js')}}"></script>
<script src="{{asset('assets/crypto/js/datepicker/date-picker/datepicker.custom.js')}}"></script>
<script src="{{asset('assets/crypto/js/typeahead/handlebars.js')}}"></script>
<script src="{{asset('assets/crypto/js/typeahead/typeahead.bundle.js')}}"></script>
<script src="{{asset('assets/crypto/js/typeahead/typeahead.custom.js')}}"></script>
<script src="{{asset('assets/crypto/js/typeahead-search/handlebars.js')}}"></script>
<script src="{{asset('assets/crypto/js/typeahead-search/typeahead-custom.js')}}"></script>
{{--  <script src="{{asset('assets/crypto/js/theme-customizer/customizer.js')}}"></script>  --}}


<script src="{{asset('assets/templates/minimal/js/chart.js')}}"></script>
<script>
    var options = {
        chart: {
          height: 280,
        ...
        xaxis: {
          categories: @json($collection['day'])
        }
      };
