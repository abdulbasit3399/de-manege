...
<section id="subscribe" class="newslater-section padding overlay-1 bg_img pos-rel" data-paroller-factor="0.10"
    ...
    <div class="star-1">
        <img src="{{asset($activeTemplateTrue.'images/animation/01.png')}}" alt="shape">
    </div>

    <div class="circle-1">
        <img src="{{asset($activeTemplateTrue.'images/animation/02.png')}}" alt="shape">
    </div>

    <div class="trop-1">
        <img src="{{asset($activeTemplateTrue.'images/animation/03.png')}}" alt="shape">
    </div>

    <div class="star-2">
        <img src="{{asset($activeTemplateTrue.'images/animation/04.png')}}" alt="shape">
    </div>
    ...
    <div class="star-3">
        <img src="{{asset($activeTemplateTrue.'images/animation/06.png')}}" alt="shape">
    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-header">
                        ...
                        <p>{{__(@$subscribeCaption->data_values->sub_heading)}}</p>
                    </div>
                </div>
            </div>
