            ...
            <div class="row mb-30-none">
                @foreach($authWallets as $data)
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8 mb-30">
                        <div class="privacy-item">
                            <h3 class="title">{{__(str_replace('_',' ',strtoupper($data->wallet_type)))}}</h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8 mb-30">
                    <div class="privacy-item">
                        ...
                        <a href="{{route('user.withdraw.history')}}" class="privacy-btn">@lang('View Report')</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8 mb-30">
                    <div class="privacy-item">
                        ...
                        <span class="total-amount">{{$totalTicket}}</span>
                        <a href="{{route('ticket')}}" class="privacy-btn">@lang('View Report')</a>
                    </div>
                </div>
