                        ...
                        <div class="card card-deposit">
                            ...
                            <div class="card-footer">
                                <a href="javascript:void(0)"  data-id="{{$data->id}}"
                                   ...
                                   class="btn  amr-btn custom-success deposit" data-toggle="modal" data-target="#exampleModal">
                                    @lang('Withdraw Now')</a>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            $('.deposit').on('click', function () {
                ...
                var depositCharge = `@lang('Charge:') ${fixCharge} {{$general->cur_text}} + ${percentCharge} %`
