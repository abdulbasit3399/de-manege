@php
    $investorCaption = getContent('top_investor.content',true);
@endphp
@if($investorCaption)
    @php
            ...
            <div class="row justify-content-center ">
                <div class="col-10 text-center">
                    <div class="section-header mb-5">
                        <h2 class="title">{{__(@$investorCaption->data_values->heading)}} </h2>
                        <p class="section-para">{{__(@$investorCaption->data_values->sub_heading)}}</p>
                    </div>
                </div>
            </div>
