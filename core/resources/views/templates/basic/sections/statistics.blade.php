@php
    $statisticsCaption = getContent('statistics.content',true);
@endphp
            ...
            <div class="row justify-content-center ">
                <div class="col-10 text-center">
                    <div class="section-header mb-5">
                        <h2 class="title">{{__(@$statisticsCaption->data_values->heading)}} </h2>
                        <p class="section-para">{{__(@$statisticsCaption->data_values->sub_heading)}}</p>
                    </div>
                </div>
            </div>
            <div class="row">
