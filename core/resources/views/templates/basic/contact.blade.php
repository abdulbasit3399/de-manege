...
@section('content')
    ...
    <div class="contact-area padding-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-page contact_wrapper">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="contact-form-area">
                                    <h3 class="section-title">{{__($contact->data_values->title)}}</h3>
                                ...
                                <div class="contact-social-area">
                                    ...
                                    <div class="mail-area">
                                        <span class="support">
                                            ...
                                            <a href="javascript:void(0)">
                                                @php echo  $contact->data_values->contact_number @endphp
                                            </a>
                                        </span>

                                        <span class="support mt-1">
                                            <i class="fas fa-envelope"></i><a href="javascript:void(0)" >@php echo  $contact->data_values->email_address @endphp</a>
                                        </span>


                                        <span class="support mt-1"><i class="fas fa-location-arrow"></i><a href="javascript:void(0)">
                                                @php echo  $contact->data_values->contact_details @endphp</a>
                                        </span>
                                    ...
                                    <ul class="social-links">
                                        @foreach($socials as $data)
                                            <li><a href="{{$data->data_values->url}}" target="_blank" title="{{$data->data_values->title}}">{!! $data->data_values->icon !!}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
