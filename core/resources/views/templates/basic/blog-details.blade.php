                ...
                <div class="col-lg-8">
                        ...
                        <div class="blog-post ">
                            ...
                            <div class="blog-outer ">
                                ...
                                <h2 class="blog-title text-white">{{__($post->data_values->title)}} </h2>

                                <p class=" mt-4 text-left text-white  blog-article-info blog-text">{{strip_tags($post->data_values->description)}}</p>
