                                    ...
                                    <div class="col-md-4">
                                        <div class="user-info-item three">
                                            <div class="user-info-header">
                                                ...
                                                <div class="right">
                                                    <a href="{{route('user.withdraw.history')}}" class="privacy-btn">
                                                    <img src="{{asset($activeTemplateTrue.'images/user/withdraw.png')}}" alt="user">
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="user-info-item two">
                                            <div class="user-info-header">
                                                <div class="left">
                                                    ...
                                                    <h4 class="title">{{$totalTicket}}</h4>
                                                </div>
                                                <div class="right">

                                                    <a href="{{route('ticket')}}" class="privacy-btn">
