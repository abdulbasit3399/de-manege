                ...
                @foreach($testimonial as $data)
                    <div class="owl-thumb-item">
                        <div class="thumb wow zoomIn" data-wow-duration="1s" >
                            <img src="{{asset('assets/images/frontend/testimonial/'.$data->data_values->image)}}" alt="client">
                        </div>
                    </div>
                @endforeach
                        ...
                        <div class="client-slide-item">
                            ...
                            <div class="author">
                                ...
                                <div class="author-content">
                                    <h6 class="sub-title"><a href="javascript:void(0)">{{__($data->data_values->author)}}</a></h6>
