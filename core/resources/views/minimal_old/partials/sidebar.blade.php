    ...
    <div class="user-area">
        ...
        <ul class="tab-menu">
            <li @if(Request::routeIs('user.home')) class="active" @endif>
               ...
               <li @if(Request::routeIs('home.invest')) class="active" @endif>
                <a href="{{route('home.invest')}}"><i class="fas fa-cubes"></i> @lang('My Investment')</a></li>
            ...
            <li @if(Request::routeIs('user.withdraw')) class="active" @endif>
                <a  href="{{route('user.withdraw')}}"><i class="fas fa-university"></i> @lang('Withdraw Now')</a>
            </li>

            <li @if(Request::routeIs('user.withdraw.history')) class="active" @endif>
                <a  href="{{route('user.withdraw.history')}}"> <i class="fas fa-file-alt"></i>  @lang('Withdraw History')</a>
            </li>
            ...
            <li @if(Request::routeIs('ticket')) class="active" @endif>
                <a  href="{{route('ticket')}}"><i class="fas fa-ticket-alt"></i> @lang('Support Ticket')</a>
            </li>

            <li @if(Request::routeIs('user.twofactor')) class="active" @endif>
                <a  href="{{route('user.twofactor')}}"><i class="fas fa-shield-alt"></i>  @lang('2FA Security')</a>
            </li>
            
             <li @if(Request::routeIs('document')) style="display:none;" class="active" @endif>
                <a style="display:none;" href="{{route('document')}}"><i class="fa fa-file"></i>  @lang('My Document')</a>
            </li>
