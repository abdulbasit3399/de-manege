...
<footer class="footer-top padding-top">
    ...
    <div class="tree1">
        <img src="{{asset($activeTemplateTrue.'images/footer/tree1.png')}}" alt="footer">
    </div>
    <div class="tree2 wow slideInUp">
        <img src="{{asset($activeTemplateTrue.'images/footer/tree2.png')}}" alt="footer">
    </div>
    <div class="futa">
        <img src="{{asset($activeTemplateTrue.'images/footer/futa.png')}}" alt="footer">
    </div>
    <div class="futa two">
        <img src="{{asset($activeTemplateTrue.'images/footer/futa.png')}}" alt="footer">
    </div>
    <div class="coin-3">
        <img src="{{asset($activeTemplateTrue.'images/footer/coin1.png')}}" alt="footer">
    </div>
