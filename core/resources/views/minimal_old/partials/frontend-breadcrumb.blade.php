        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="page-header-thumb wow slideInDown">
                    <img src="{{asset($activeTemplateTrue.'images/breadcrumb/page-header-01.png')}}" alt="page-header">
                    <div class="coin wow bounceInDown" data-wow-delay=".5s">
                        <img src="{{asset($activeTemplateTrue.'images/breadcrumb/coin.png')}}" alt="page-header">
                    </div>
                </div>
            </div>
        </div>
