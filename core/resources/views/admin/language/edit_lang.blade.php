                    ...
                    <form method="post" action="{{route('admin.language.key-update', $la->id)}}" id="langForm">
                        ...
                        <div class="form-body">
                            ...
                            <div class="py-5  text-right  ">
                                <button type="button" data-toggle="modal" data-target="#addModal" class="btn btn-dark"> <i class="fa fa-plus"></i> Add New Key</button>
                            </div>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <button class="btn btn-block btn-lg btn-success" data-toggle="tooltip" title="Save" @click.prevent="save">Update Language</button>
                                </div>
                            </div>
                        </div>
                    </form>
