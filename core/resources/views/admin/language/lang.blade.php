                ...
                <table class="table align-items-center table-light">
                    ...
                    @forelse ($languages as $item)
                        <tr>
                            ...
                            <td>
                                @if($item->id != 1)
                                <a class="btn btn-primary" href="{{route('admin.language-key', $item->id)}}"><i class="fa fa-fw fa-code"></i></a>
                                @endif

                                <button type="button" class="btn btn-primary editBtn" data-url="{{ route('admin.language-manage-update', $item->id)}}" data-lang="{{ json_encode($item->only('name', 'icon', 'text_align', 'is_default')) }}"><i class="fa fa-fw fa-edit"></i></button>
                                    @if($item->id != 1)
                                <button type="button" class="btn btn-danger bold uppercase deleteBtn" data-url="{{ route('admin.language-manage-del', $item->id) }}"> <i class='fa fa-fw fa-trash'></i></button>
                                    @endif
                            </td>
                        </tr>  
                    @empty
