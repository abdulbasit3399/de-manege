                ...
                <div class="card-body">
                    <div class="price-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <h5 class="text-right">{{ $plugin->name }}</h5>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-footer d-flex justify-content-between">
                    <button class="btn btn-primary editBtn" data-name="{{ $plugin->name }}" data-shortcode="{{ json_encode($plugin->shortcode) }}" data-action="{{ route('admin.plugin.update', $plugin->id) }}"><i class="fa fa-fw fa-cogs"></i> Configure</button>
