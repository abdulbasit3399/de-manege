                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group has_append">    
                                            ...
                                            <input type="text" class="form-control" placeholder="0" name="rate" value="{{ $method->single_currency->rate +0 }}"/>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"  name="delay" class="form-control border-radius-5" value="{{ $method->extra->delay }}" />
                                    </div>
                                </div>
