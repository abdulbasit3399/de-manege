...
<div class="col-lg-12">
  <div class="card">
          ...
          <div class="payment-method-header d-flex flex-wrap">
            <div class="thumb">
              ...
              <div class="content">
                <div class="d-flex justify-content-between">
                  <div>
                    <h4 class="mb-3">{{ $gateway->name }} - {{$gateway_currency->currency}}</h4>
                    <input type="text" class="form-control" placeholder="Name for Gateway" name="currency[{{ $currency_idx }}][name]" value="{{ $gateway_currency->name }}" required />
                  </div>
            ...
            <div class="payment-method-body">
              <div class="row">
                ...
                @php
                $parameteres = json_decode($gateway_currency->gateway_parameter);
                @endphp
                <div class="col-lg-12">
                  <div class="card outline-primary">
                ...
                <div class="content">
                  <div class="d-flex justify-content-between">
                    <div>
                      ...
                      <input disabled type="text" class="form-control" placeholder="Name for Gateway" name="currency[{{ $currency_idx }}][name]" required />
                    </div>
                    <div class="remove-btn">
    ...
    <a href="{{ route('admin.deposit.gateway.index') }}" class="btn btn-dark"><i class="fa fa-fw fa-backward"></i>Go Back</a>
    @endpush
