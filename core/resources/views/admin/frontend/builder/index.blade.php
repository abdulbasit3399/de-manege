                                ...
                                <form action="{{route('admin.frontend.manage.section.update',$pdata->id)}}" method="post">
                                    ...
                                    <ol class="simple_with_drop vertical sec-item">
                                        ...
                                        <li class="highlight icon-move">
                                            ...
                                            <span class="d-inline-block mr-auto ml-2"> {{ @$sections[$sec]['name']}}</span>
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block btn-lg pt-3">Update Now</button>
                                </form>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <ol class="simple_with_no_drop vertical">
                                    ...
                                    <li class="highlight icon-move">
                                        <i class=" fa fa-arrows-alt"></i>
                                        <span class="d-inline-block mr-auto ml-2"> {{$secs['name']}}</span>
                                        <i class="ml-auto d-inline-block remove-icon fa fa-times"></i>
...
<a href="{{route('admin.frontend.manage.pages')}}"  class="btn btn-dark"><i class="fa fa-fw fa-backward"></i> Go Back </a>
@endpush
