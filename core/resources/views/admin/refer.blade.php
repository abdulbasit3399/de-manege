                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <form action="{{ route('admin.setting.update.other') }}" method="POST">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <input type="checkbox" data-width="100%" data-onstyle="success"
                                               ...
                                               data-off="Disable" name="deposit_commission"
                                               @if($general->deposit_commission) checked @endif>
                                    </div>
                                    <div class="form-group col">
                                        <p class="text-muted">Invest Commission</p>
                                        <input type="checkbox" data-width="100%" data-onstyle="success"
                                               data-offstyle="danger" data-toggle="toggle" data-on="Enable"
                                               data-off="Disable" name="invest_commission"
                                               @if($general->invest_commission) checked @endif>
                                    </div>
                                    <div class="form-group col">
                                        <p class="text-muted">Interest return commission</p>
                                        <input type="checkbox" data-width="100%" data-onstyle="success"
                                               data-offstyle="danger" data-toggle="toggle" data-on="Enable"
                                               data-off="Disable" name="invest_return_commission"
                                               @if($general->invest_return_commission) checked @endif>
                                    </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('admin.store.refer')}}" id="prantoForm" style="display: none"
                                  method="post">
                                {{csrf_field()}}
