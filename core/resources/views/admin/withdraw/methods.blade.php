                ...
                <table class="table align-items-center table-light">
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            ...
                            <td class="budget">{{ $method->fixed_charge + 0 }} {{$general->cur_text }} + {{ $method->percent_charge + 0 }} %</td>
                            <td class="budget">{{ $method->min_limit + 0 }}  - {{ $method->max_limit + 0 }} {{$general->cur_text }}</td>
                            <td>{{ $method->delay }}</td>
                            <td>
